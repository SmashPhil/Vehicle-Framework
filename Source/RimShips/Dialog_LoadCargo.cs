...
namespace Vehicles
{
    ...
    {
        public Dialog_LoadCargo(VehiclePawn boat)
        {
            this.boat = boat;
            closeOnAccept = true;
            closeOnCancel = true;
        ...
        public float MassUsage
        {
            get
            {
                if(massUsageDirty)
                {
                    ...
                    cachedMassUsage += MassUtility.GearAndInventoryMass(boat);
                }
        ...
        public override void DoWindowContents(Rect inRect)
        {
            ...
            Widgets.Label(rect, boat.LabelShortCap);
				...
				if (Widgets.ButtonText(new Rect(0f, rect.height - 55f - 17f, width, num), "Dev: Pack Instantly", true, true, true))
				{
                    ...
                    for(int i = 0; i < transferables.Count; i++)
                    {
                        ...
                        if(transferred is null)
                        {
                            ...
                            {
                                boat.inventory.innerContainer.TryAdd(thing, true);
                            };
                        }
