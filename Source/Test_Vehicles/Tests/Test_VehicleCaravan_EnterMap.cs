...
internal sealed class Test_VehicleCaravan_EnterMap
{
  private static readonly IntVec3 TestMapSize = new(75, 1, 75);
  ...
  [Test]
  [TestDescription("Setting up camp correctly spawns all pawns, places the vehicle, and destroys the " +
                   "caravan with no vanilla caravan artifact.")]
