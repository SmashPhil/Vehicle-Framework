...
internal sealed class UnitTest_Regions : UnitTest_MapTest
{
  ...
  private static readonly AccessTools.FieldRef<VehicleRegionMaker, ObjectPool<VehicleRegion>> RegionPoolRef;
  private static readonly AccessTools.FieldRef<VehicleRegionLinkDatabase, ObjectPool<VehicleRegionLink>> RegionLinkPoolRef;

  static UnitTest_Regions()
  {
    RegionPoolRef = AccessTools.FieldRefAccess<VehicleRegionMaker, ObjectPool<VehicleRegion>>("regionPool");
    RegionLinkPoolRef = AccessTools.FieldRefAccess<VehicleRegionLinkDatabase, ObjectPool<VehicleRegionLink>>("linkPool");
  }
  ...
  private void Generation()
  {
    ...
    foreach (VehiclePawn vehicle in vehicles)
    {
      ...
      VehicleRegionGrid regionGrid = pathData.VehicleRegionGridManager[RegionGridType.Normal];
      ...
      RegionPoolRef.Invoke(regionMaker).PreWarm(PreWarmRegionCount);
      RegionLinkPoolRef.Invoke(regionMaker.linkDatabase).PreWarm(PreWarmLinkCount);
