...
internal sealed class Test_MapGeneration_River
{
  ...
  private static readonly HarmonyMethod GetRiverWidthPostfixMethod =
    new(AccessTools.Method(typeof(Test_MapGeneration_River), nameof(GetRiverWidthPostfix)),
      HarmonyLib.Priority.First);

  private static readonly HarmonyMethod GetRiverWidthFinalizerMethod =
    new(AccessTools.Method(typeof(Test_MapGeneration_River), nameof(GetRiverWidthFinalizer)));
