...
public class VehicleCaravanTweener
{
  ...
  public VehicleCaravanTweener(VehicleCaravan caravan)
  {
  ...
  {
    get { return TweenedPos - lastTickSpringPos; }
  }
  ...
  private Vector3 TweenedPosRoot
  {
    get
    {
      return VehicleCaravanTweenerUtility.PatherTweenedPosRoot(caravan) +
        VehicleCaravanTweenerUtility.CaravanCollisionPosOffsetFor(caravan);
    }
  }
