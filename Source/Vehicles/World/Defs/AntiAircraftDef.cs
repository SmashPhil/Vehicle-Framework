...
public class AntiAircraftDef : WorldObjectDef
{
  ...
  public AirDefenseProperties properties = new();
  ...
  public override IEnumerable<string> ConfigErrors()
  {
    ...
    {
      yield return "<field<accuracy</field> must be a float value between 0 and 1."
       .ConvertRichText();
    }
    if (explosionGraphic != null && explosionGraphic.graphicClass == typeof(Graphic_Animate) &&
      framesForExplosion < 0)
    {
      yield return
        "using <type>Graphic_Animate</type> class requires <field>framesPerExplosion</field> to be populated"
         .ConvertRichText();
    }
