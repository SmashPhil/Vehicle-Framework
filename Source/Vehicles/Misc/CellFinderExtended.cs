    ...
    public static class CellFinderExtended
    {
        ...
        public static IntVec3 MiddleEdgeCell(Rot4 dir, Map map, Pawn pawn, Predicate<IntVec3> validator)
        {
            ...
            for (int j = 0; j < 10000; j++)
            {
                ...
                if(VehicleHarmony.debug) Log.Message("Found: " + c);
                return c;
                Block_Skip:;
                if(VehicleHarmony.debug) GenSpawn.Spawn(ThingDefOf.AIPersonaCore, c, map);
            }
            ...
            while (cellsToCheck.Count > 0 && i < cellsToCheck.Count / 2)
            {
                ...
                if (VehicleHarmony.debug) Log.Message("Checking r: " + rCell + " | " + validator(rCell));
                ...
                if (VehicleHarmony.debug) Log.Message("Checking l: " + lCell + " | " + validator(lCell));
                ...
                Block_1:;
                i++;
                if (VehicleHarmony.debug) Log.Message("==============");
            }
