...
public class Graphic_Animate : Graphic_Collection
{
  ...
  {
    return GraphicDatabase.Get<Graphic_Animate>(path, newShader, drawSize, newColor, newColorTwo,
      data);
  }

  public void DrawWorkerAnimated(Thing thing, int index, float extraRotation,
  ...
  public void DrawWorkerAnimated(Vector3 loc, Rot4 rot, int index, float extraRotation,
    bool rotatePoints = false)
  {
