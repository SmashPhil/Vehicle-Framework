...
#region Gizmos
	...
	public static readonly Texture2D GearForward =
		ContentFinder<Texture2D>.Get("UI/Gizmos/GearDrive");

	public static readonly Texture2D GearReverse =
		ContentFinder<Texture2D>.Get("UI/Gizmos/GearReverse");
