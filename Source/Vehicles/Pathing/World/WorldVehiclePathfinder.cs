...
public class WorldVehiclePathfinder : WorldComponent
{
  ...
  public WorldVehiclePathfinder(RimWorld.Planet.World world) : base(world)
  {
    this.world = world;
  ...
  /// </summary>
  public WorldPath FindPath(PlanetTile startTile, PlanetTile destTile, VehicleCaravan caravan,
  ...
  /// </summary>
  public WorldPath FindPath(PlanetTile startTile, PlanetTile destTile, List<VehiclePawn> vehicles,
