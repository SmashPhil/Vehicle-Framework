...
public static class VehicleReachabilityUtility
{
  ...
  public static bool CanReachVehicle(this VehiclePawn vehicle, LocalTargetInfo dest, PathEndMode peMode,
    Danger maxDanger, TraverseMode mode = TraverseMode.ByPawn)
  {
    ...
    return vehicle.Spawned && MapComponentCache<VehiclePathingSystem>.GetComponent(vehicle.Map)[vehicle.VehicleDef]
     .VehicleReachability.CanReachVehicle(vehicle.Position, dest, peMode, TraverseParms.For(vehicle, maxDanger, mode));
  }
  ...
  /// <param name="maxDanger"></param>
  /// <param name="mode"></param>
  public static bool CanReachVehicleNonLocal(this VehiclePawn vehicle, TargetInfo dest, PathEndMode peMode,
    Danger maxDanger, TraverseMode mode = TraverseMode.ByPawn)
  {
    if (dest.Cell == vehicle.Position)
    {
    ...
    return vehicle.Spawned && MapComponentCache<VehiclePathingSystem>.GetComponent(vehicle.Map)[vehicle.VehicleDef]
     .VehicleReachability.CanReachVehicleNonLocal(vehicle.Position, dest, peMode,
  ...
  {
    return vehicle.Spawned && MapComponentCache<VehiclePathingSystem>.GetComponent(vehicle.Map)[vehicle.VehicleDef]
     .VehicleReachability.CanReachMapEdge(vehicle.Position,
  ...
  public static void ClearCacheFor(VehiclePawn vehicle)
  {
    ...
    {
      maps[i].GetCachedMapComponent<VehiclePathingSystem>()[vehicle.VehicleDef].VehicleReachability
       .ClearCacheFor(vehicle);
    }
  }
}