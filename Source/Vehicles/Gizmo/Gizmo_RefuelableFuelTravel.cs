...
public class Gizmo_RefuelableFuelTravel : Gizmo_Slider
{
  ...
  public override GizmoResult GizmoOnGUI(Vector2 topLeft, float maxWidth, GizmoRenderParms parms)
  {
    ...
    if (IsDraggable && Mouse.IsOver(barRect))
    {
  ...
  protected override void DrawHeader(Rect headerRect, ref bool mouseOverElement)
  {
    ...
    // NOTE: Vanilla has a mod-only bug where the tooltip is shown even for blank strings.
    // mouseOverElement suppresses the highlight + tooltip, so we have to draw our own.
