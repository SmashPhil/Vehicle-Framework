...
namespace Vehicles
{
  public class JobDriver_RefuelVehicle : JobDriver
  {
    ...
    {
      get { return job.GetTarget(TargetIndex.A).Thing as VehiclePawn; }
    }
    ...
    protected override IEnumerable<Toil> MakeNewToils()
    {
      ...
      yield return Toils_General.Wait(RefuelingDuration, TargetIndex.None).FailOnDestroyedNullOrForbidden(TargetIndex.B)
