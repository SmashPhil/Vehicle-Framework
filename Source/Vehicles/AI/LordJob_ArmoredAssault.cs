...
namespace Vehicles
{
    public class LordJob_ArmoredAssault : LordJob
    {
		...
		public LordJob_ArmoredAssault(Faction assaulterFaction, bool canKidnap = true, bool canTimeoutOrFlee = true, bool sappers = false, bool useAvoidGridSmart = false, bool canSteal = true)
		{
		...
		public override void ExposeData()
		{
			...
			Scribe_Values.Look(ref sappers, "sappers", false, false);
			Scribe_Values.Look(ref useAvoidGridSmart, "useAvoidGridSmart", false, false);
