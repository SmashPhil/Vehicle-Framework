                          ...
                          IBlitTarget, IDisposable
{
  ...
  public VehiclePortrait Portrait { get; private set; }
  ...
  {
    Rect adjustedRect = VehicleGraphics.AdjustRectToVehicleDef(this, rect, request.rot);
