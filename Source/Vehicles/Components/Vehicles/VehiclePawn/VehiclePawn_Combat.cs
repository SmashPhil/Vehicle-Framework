...
public partial class VehiclePawn
{
  ...
  public float BuildingCollisionMultiplier
  {
    get
    {
      float multiplier = SettingsCache.TryGetValue(VehicleDef, typeof(VehicleProperties),
        nameof(VehicleProperties.buildingCollisionMultiplier),
        VehicleDef.properties.buildingCollisionMultiplier);
      multiplier =
        statHandler.GetStatOffset(VehicleStatUpgradeCategoryDefOf.BuildingCollisionMultiplier,
          multiplier);
      return multiplier;
    }
  }

  public float BuildingCollisionRecoilMultiplier
  {
    get
    {
      float multiplier = SettingsCache.TryGetValue(VehicleDef, typeof(VehicleProperties),
        nameof(VehicleProperties.buildingCollisionRecoilMultiplier),
        VehicleDef.properties.buildingCollisionRecoilMultiplier);
      multiplier =
        statHandler.GetStatOffset(VehicleStatUpgradeCategoryDefOf.BuildingCollisionRecoilMultiplier,
          multiplier);
      return multiplier;
    }
  }
