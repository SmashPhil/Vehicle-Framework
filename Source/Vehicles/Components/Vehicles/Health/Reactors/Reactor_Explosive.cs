...
namespace Vehicles
{
	public class Reactor_Explosive : Reactor
	{
		...
		{
			if (penetration == VehicleComponent.Penetration.Penetrated && component.health <= maxHealth && Rand.Chance(chance) && component.props.hitbox.cells.TryRandomElement(out IntVec2 offset))
			{
