                              ...
                              ITweakFields
{
  ...
  /// created so for def-overlays (e.g. drawing in the <see cref="MainTabWindow_Architect"/> menu) <see cref="VehicleDef"/> should be used instead.
  /// </remarks>
