...
internal class Patch_PawnAi : IPatchCategory
{
  ...
  private static void EjectPawnForMentalState(Pawn ___pawn)
  {
    if (___pawn.ParentHolder is not VehicleRoleHandler handler)
      return;
    ...
    if (___pawn.IsCaravanMember())
    {
      ...
      {
        Messages.Message("VF_VehicleCaravanMentalBreakMovementRole".Translate(___pawn),
