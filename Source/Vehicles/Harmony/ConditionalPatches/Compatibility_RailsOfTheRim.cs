...
namespace Vehicles
{
	...
	{
		public override string PackageId => CompatibilityPackageIds.RailsOfTheRim;
		...
		private static IEnumerable<CodeInstruction> GetAlertReportIdleConstructionVehicle(IEnumerable<CodeInstruction> instructions)
		{
			...
			for (int i = 0; i < instructionList.Count; i++)
			{
				...
				{
					yield return new CodeInstruction(opcode: OpCodes.Call, operand: AccessTools.Method(typeof(Compatibility_RailsOfTheRim), nameof(Compatibility_RailsOfTheRim.CaravanMovingNow)));
