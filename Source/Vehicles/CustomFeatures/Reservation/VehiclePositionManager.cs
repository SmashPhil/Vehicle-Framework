...
public class VehiclePositionManager : DetachedMapComponent
{
	...
	/// </remarks>
	public List<VehiclePawn> AllClaimants => claimants;
	...
	{
		// NOTE - Updating position manager is done from vehicle pather logic. This allows us to have a thread-unsafe list
