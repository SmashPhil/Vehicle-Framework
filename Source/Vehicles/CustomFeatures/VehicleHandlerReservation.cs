...
namespace Vehicles
{
    public class VehicleHandlerReservation : Reservation<VehicleHandler>
    {
        ...
        {
            base.ExposeData();
            Scribe_Collections.Look(ref claimants, "claimants", LookMode.Reference, LookMode.Deep);
            Scribe_Collections.Look(ref handlerClaimants, "handlerClaimants", LookMode.Deep, LookMode.Value);
        }
