...
public static class VehicleSkyfallerMaker
{
  ...
  public static VehicleSkyfaller MakeSkyfaller(ThingDef def, VehicleDef vehicleDef, Faction faction,
    bool randomizeColors = false, bool randomizeMask = false, bool cleanSlate = true)
  {
    ...
    skyfaller.vehicle =
      VehicleSpawner.GenerateVehicle(new VehicleGenerationRequest(vehicleDef, faction, randomizeColors, randomizeMask,
        cleanSlate));
    return skyfaller;
  }
  ...
  public static VehicleSkyfaller_FlyOver MakeSkyfallerFlyOver(ThingDef def, VehiclePawn vehicle, IntVec3 start,
    IntVec3 end)
  {
    try
    {
