...
[PublicAPI]
public class AerialVehicleArrivalAction_VisitSettlement
  : AerialVehicleArrivalAction_FormVehicleCaravan
{
    ...
    Settlement settlement)
  {
    return VehicleArrivalActionUtility.GetFloatMenuOptions(() => CanVisit(vehicle, settlement),
      ...
      "VisitSettlement".Translate(settlement.Label), vehicle, settlement.Tile);
  }
}