...
public static class AerialVehicleLaunchHelper
{
	public static AerialVehicleInFlight GetOrMakeAerialVehicle(this VehiclePawn vehicle)
	{
		...
		VehicleWorldObjectsHolder worldObjHolder = Find.World.GetComponent<VehicleWorldObjectsHolder>();
		AerialVehicleInFlight aerialVehicle = worldObjHolder.AerialVehicleObject(vehicle);
		if (aerialVehicle == null)
		{
			VehicleCaravan vehicleCaravan = worldObjHolder.VehicleCaravanObject(vehicle);
