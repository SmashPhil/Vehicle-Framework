...
public static class GizmoHelper
{
		...
		Faction faction = null, TraderKindDef trader = null)
	{
		...
		{
			if (trader?.permitRequiredForTrading != null && !aerialVehicle.Vehicle.AllPawnsAboard.Any((pawn) =>
				pawn.royalty != null && pawn.royalty.HasPermit(trader.permitRequiredForTrading, faction)))
			{
		...
		if (bestNegotiator != null &&
			bestNegotiator.skills?.GetSkill(SkillDefOf.Social) is { TotallyDisabled : true })
		{
