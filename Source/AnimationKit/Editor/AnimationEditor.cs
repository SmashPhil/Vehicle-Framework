...
internal abstract class AnimationEditor(Window window)
{
  ...
  public virtual void OnGUIHighPriority()
  {
    ...
    if (Event.current.keyCode is KeyCode.Delete or KeyCode.Backspace)
    {
      Delete();
    }
  ...
  public static bool Dropdown(Rect rect, string label, string tooltip)
  {
    ...
    {
      Verse.UI.RotateAroundPivot(90, dropdownRect.center);
  ...
  {
    Vector2 mousePos = new(Verse.UI.MousePositionOnUIInverted.x, Verse.UI.MousePositionOnUIInverted.y);
